%%%-------------------------------------------------------------------
%%% @author Ubuntu <gulu@gulumail.com>
%%% @copyright (C) 2011, Ubuntu
%%% @doc
%%% API for Django interaction and reporting
%%% @end
%%% Created : 30 Jun 2011 by Ubuntu <gulu@gulumail.com>
%%%-------------------------------------------------------------------
